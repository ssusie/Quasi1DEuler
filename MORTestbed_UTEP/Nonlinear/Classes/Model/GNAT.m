...
%            obj.phiYhat = romobj.phi(unique(obj.jrow),:);
        ...
        function  [] = executeModel(obj)
            ...
            if obj.solver == 2
                ...
                obj.PsiFQ     = u_Q;
%                 keyboard
                reconFl_g = obj.PsiFleft  * pinv(obj.PsiFleft (obj.reconLocs, :));
                reconFr_g = obj.PsiFright * pinv(obj.PsiFright(obj.reconLocs, :));
                reconFq_g = obj.PsiFQ  * pinv(obj.PsiFQ(obj.sampleNodes(2:end), :));
