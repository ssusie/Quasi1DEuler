classdef Lorenz
    ...
    methods
        function  [obj] = Lorenz(cfgobj,oldobj)
            %This is the constructor for the Lorenz attractor probleme.
            ...
            %oldobj - Lorenz object whose properties will be copied
            %         into the new object.
            %
            %Outputs:
            %--------
            ...
            [obj.rho,obj.beta,obj.sigma] = feval(obj.config.altFile);
        ...
        %This function calcuates the residual and jacobian of the Lorenz attractor problem
        %------------------------------------------------------------------
        %Inputs:
        %-------
        %obj - Lorenz object
        ...
        R = [obj.sigma*(v(2,1)-v(1,1));...
                obj.rho*v(1,1) - v(2,1) - v(1,1)*v(3,1);...
                -obj.beta*v(3,1) + v(1,1)*v(2,1)];
           
        J = [-obj.sigma obj.sigma 0;...
               obj.rho-v(3,1) -1 -v(1,1);...
               v(2,1) v(1,1) -obj.beta];
        ...
        function  [R,J] =  ResJacGNAT(obj,v,t)
            ...
            switch obj.caseNum
                case 1 % row 1 only
                     ...
                     J = [-obj.sigma obj.sigma];
                case 2 % row 2 only
                     R = [obj.rho*v(1,1) - v(2,1) - v(1,1)*v(3,1)];
            
                     J = [obj.rho-v(3,1) -1 -v(1,1)];                   
                case 3 % row 3 only
                     R = [-obj.beta*v(3,1) + v(1,1)*v(2,1)];
            
                     J = [v(2,1) v(1,1) -obj.beta];                     
                case 4 % rows 1 and 2
                      R = [obj.sigma*(v(2,1)-v(1,1));...
                             obj.rho*v(1,1) - v(2,1) - v(1,1)*v(3,1)];
        ...
        function  [ind] = node2ind(obj,nodenum)
            ...
            %in the full state vector for the Lorenz attractor
            %--------------------------------------------------------------
            %Inputs:
            %-------
            %obj     - Lorenz object
        ...
        function  [probGNAT] = createCopy4GNAT(obj,gnat)
            ...
            %Outputs:
            %--------
            %probGNAT - new "reduced" Lorenz object
            %--------------------------------------------------------------
        ...
        function   [axOUT] = problemPaperPlot(obj,modelobj,modelAuxobj,pstr,axIN)
            %This function generates the Lorenz attractor 3D plot
            %
            %--------------------------------------------------------------
            %Inputs:
            %-------
